export const portfolioContent = {
	jumbotron: {
		...
		infoList: ['A front-end developer', 'Really into coding'],
	...
	worked: {
		title: 'I’ve Worked in',
		list: [
			{
				title: '👨🏻‍ Senior Front-end Developer',
				type: 'Full-time',
				company: 'Jaytoon',
				duration: '📆 September 2020  –present 5 months',
				location: '🏢 Sydney, Australia (Remote, International product)',
				description: `As a team member, I'm working here on a task/project basis. job. Working on various projects in agile.`,
			},
			{
				title: '👨🏻‍ Senior Front-end Developer',
				company: 'Techlinked',
				type: 'Full-time',
				duration: '📆 October 2019  –present 17 months',
				location: '🏢 California, USA (Remote, International product)',
				description: `A platform for industrial equipment, their experts and their service-providing companies that includes a series of social-media features like feed, follow, etc. The company is based in Silicon valley.`,
			},
			{
				title: '👨🏻‍ Senior Front-end Developer',
				company: 'Techlinked',
